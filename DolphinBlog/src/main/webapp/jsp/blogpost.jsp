...
<h2>  <c:out value="${pub_date}" default="Didn't work"/> </h2>-->
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div id="pop1" class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    ...
                                    <div style="height:23px;" id="work" class="col-md-4">
                                    <h3  id="like-text-test-page" style="color:white;display:inline-block"><a id="like-button-test-page"><span id="like-glyph" class="glyphicon glyphicon-thumbs-up"></span></a><h3 id="likes-display" style="display:inline-block">(${likes})</h3></h3>
                                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <div id="commentDiv" class="col-md-12 input-group">
                                            <textarea id="newCommentBox" placeholder="Join the conversation!" style="width:100%; height: 120px; border-radius:10px; color:gray;"></textarea>
                                            <button id="addCommentBtn" class="col-sm-3 btn btn-lg btn-default" type="button">
                                                Add Comment
                                            </button>
                                        </div>
                                        <div id="refreshPageMsg" class="text-center">
                                            <h3>Your Comment will be visible when the page is refreshed</h3>
                                        </div>
                                        ...
                                        <c:forEach items="${comments}" var="comment">
                                            <tr>
                                                ...
                                                <td><p>${comment}</p></td>
                                        <sec:authorize access="hasAnyRole('ROLE_ADMIN')">        <td><button style="width:90px;" class="delete-comment-button btn btn-primary" data-comment-id="${commentMap.get(comment)}"  type="button">Delete</button></td></sec:authorize>
                                                <td><div id="comment-value-div" style="display:none;">${commentMap.get(comment)}</div></td>
                    ...
                    <div id="right" class="col-xs-4">
                        ...
                        </div> <!--GENERATED CONTENT FOR SMALL P
            ...
            <div id="secret-post-id-div" style="display:none">${postIdentifier}</div>
                <div id="secret-likes-div" style="display:none">${likes}</div>
                ...
                <script src="${pageContext.request.contextPath}/js/blogpost.js"></script>
                 <script src="${pageContext.request.contextPath}/js/NavBarBlogPost.js"></script>
            </body>
        </html>